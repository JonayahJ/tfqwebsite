"""
Django settings for tfqwebsite project.
...
SECRET_KEY = 'django-insecure-7h5#njq-k=5@&ks2+!+!+8kp25(-s922#@cku5to!o)iz^q7ua'
...
WSGI_APPLICATION = 'tfqwebsite.wsgi.application'
